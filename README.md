An implementation of the Sobel operator for edge detection in images. Below there is an example of taking the image on the left and having the calculated image on the right.
